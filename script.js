...
const officerProfiles = {
  ...
  "legacy-members": {
    role: "Legacy Members",
    name: "Khirsten Timmons & Khila Timmons",
    noPhoto: true,
    email: "admin@cltimmons.org",
